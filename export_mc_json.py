...
def save(context, **kwargs):
    ...
    export_model = kwargs['export_model']
    export_anim = kwargs['export_anim']
    
    print('argument is', export_model, export_anim)
    ...
    if mesh_obj is not None and export_model:
    ...
    if armature_result is not None and export_model:
